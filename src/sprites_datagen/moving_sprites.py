...
from src.general_utils import AttrDict
from src.sprites_datagen.utils.template_blender import TemplateBlender
from src.sprites_datagen.utils.trajectory import ConstantSpeedTrajectory
...
if __name__ == '__main__':
    ...
    from src.sprites_datagen.rewards import ZeroReward
    spec = AttrDict(
        resolution=128,
        max_seq_len=30,
